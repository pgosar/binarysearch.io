...
import { deleteUserFromDb, getUserFromDb, updateUserInDb } from '../../../services/userService'; // Assume these are service functions
  ...
  try {
    ...
    if (!validatedUserId || !validatedUserData) {
      return res.status(400).json({
        message:
          'userId, username, email, role, profile, experience, and currentRoomCode are required to update the user',
      });
    }
